    ...
    <header class="bg-white shadow-sm sticky top-0 z-50">
        <nav class="container mx-auto px-4 py-4 flex justify-between items-center">
            ...
            <ul class="hidden md:flex space-x-8 text-gray-600 font-medium">
                <li><a style="font-weight: bold; color: black;" href="#hero" class="hover:text-indigo-600 transition duration-300">Login</a></li>
                <li><a style="font-weight: bold; color: black;"  href="#events" class="hover:text-indigo-600 transition duration-300">Enroll</a></li>
            </ul>
