...
<body class="antialiased text-gray-800">
    ...
    <header class="bg-white shadow-sm sticky top-0 z-50">
        <nav class="container mx-auto px-4 py-4 flex justify-between items-center">
            ...
            <ul class="hidden md:flex space-x-8 text-gray-600 font-medium">
                <li><a style="font-weight: bold; color: black;" href="login.php" class="hover:text-indigo-600 transition duration-300">Login</a></li>
                <li><a style="font-weight: bold; color: black;"  href="registration.php" class="hover:text-indigo-600 transition duration-300">Registration</a></li>
            </ul>
  ...
  <div class="relative z-10 flex items-center justify-center h-full text-center text-white px-4">
    <div>
      ...
      <a href="dist/image/home-view.jpg" class="mt-8 inline-block px-8 py-3 bg-indigo-600 text-white font-bold rounded-full shadow-lg hover:bg-indigo-700 transition duration-300 transform hover:scale-105">
        Get Started
      </a>
    </div>
  </div>
