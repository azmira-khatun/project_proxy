...
<body class="antialiased text-gray-800">
    ...
    <section class="relative bg-cover bg-center h-screen" style="background-image: url('dist/image/home-view.jpg')">
        ...
        <div class="relative z-10 flex items-center justify-center h-full text-center text-white px-4">
            <div>
                ...
                <a href="dist/image/home-view.jpg"
                ...
                while ($row = $events->fetch_assoc()):
                    ...
                    <div class="relative rounded-2xl overflow-hidden shadow-xl transform transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 bg-cover bg-center"
                        ...
                        <div class="relative p-6 text-white">
                            ...
                            <p class="text-sm mb-4"><i class="fas fa-calendar-alt mr-2"></i><?= $edate ?> | <i
                                    class="fas fa-map-marker-alt mr-2"></i><?= $venue ?></p>
                            ...
                            <a href="customer_book.php"
                                class="inline-block px-4 py-2 text-sm font-medium rounded-full border border-white hover:bg-white hover:text-black transition-colors duration-300">Book
                                Now</a>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="bg-gray-50 p-8 rounded-2xl shadow-md">
                    <p class="text-gray-700 italic mb-4">"EventEase completely transformed our event planning. The
    ...
    <section class="py-16 bg-indigo-600 text-white text-center">
        <div class="container mx-auto px-4">
            ...
            <p class="text-lg mb-8">Join thousands of event managers who trust EventEase to deliver exceptional
                experiences.</p>
            <a href="#"
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8 text-center md:text-left">
                ...
                <div>
                    ...
                    <p class="flex items-center justify-center md:justify-start mb-1"><i
                            class="fas fa-envelope mr-2 text-indigo-400"></i>support@eventease.com</p>
