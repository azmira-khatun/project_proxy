...
/**
 * Title: Related Post
 * Slug: ecommerce-trendy-outfits/related-post
 * Categories: ecommerce-trendy-outfits, related-post
 */
?>
...
<h4 class="wp-block-heading has-text-align-left"><strong><?php esc_html_e('Related Posts :-','ecommerce-trendy-outfits'); ?></strong></h4>
<!-- /wp:heading -->
