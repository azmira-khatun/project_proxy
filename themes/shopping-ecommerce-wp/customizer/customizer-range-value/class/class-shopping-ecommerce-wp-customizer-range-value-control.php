 ...
 * @access public
 */
class Shopping_ecommerce_WP_Customizer_Range_Value_Control extends WP_Customize_Control {
	...
	public function enqueue(){
		wp_enqueue_script( 'customizer-range-value-control', SHOPPING_ecommerce_WP_THEME_URI . 'customizer/customizer-range-value/js/customizer-range-value-control.js', array( 'jquery', 'customize-base' ), '1.0.0', true );
		wp_enqueue_style( 'customizer-range-value-control', SHOPPING_ecommerce_WP_THEME_URI . 'customizer/customizer-range-value/css/customizer-range-value-control.css', array(), '1.0.0' );
	}
	/**
	 * Handles input value.
	 *
 ...
 * @since 1.1.38
 */
function shopping_ecommerce_wp_sanitize_range_value( $input ){
	if ( shopping_ecommerce_wp_is_json( $input ) ) {
